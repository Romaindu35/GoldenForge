...
public class ActivationRange
{
    ...
    public static ActivationType initializeEntityActivationType(Entity entity)
    {
        ...
        } else if ( entity instanceof CreatureEntity || entity instanceof MobEntity)
        {
    ...
    public static void activateEntities(World world)
    {
        ...
        final ServerChunkProvider chunkProvider = (ServerChunkProvider) world.getChunkSource();
        // Paper end
    ...
    public static int checkEntityImmunities(Entity entity) // Paper - return # of ticks to get immunity
    {
        ...
        if ( entity instanceof LivingEntity)
        {
            ...
            if ( entity instanceof MobEntity && ((MobEntity) entity ).getTarget() != null) // Paper
            {
                return 20; // Paper
            }
            // Paper start
